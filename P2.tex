...
\begin{exercicio}
  ...
  Se $S_c$ é o conjunto de todos os sucessores imediatos de $c$ então definindo $g(c,n) \doteq k\big ( \{b\in S_c: \{a\in T: b\leq a\} \text{ é finita}\}\big )$ temos que $c_{n+1} = g(c_n, n)$ e portanto estamos dentro do Teorema da Recursão que vimos.
